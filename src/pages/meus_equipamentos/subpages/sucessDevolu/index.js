...
export function SucessDevolverME ({navigation}){
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.titulo}>Pedido de Devolução</Text>
            <Text style={styles.titulo}>Realizado com Sucesso!</Text>
            </View>
            <TouchableOpacity style={styles.butOK}  onPress={() => navigation.navigate('meusEquipamentos')}>
